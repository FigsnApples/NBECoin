...
//void AD5940_Delay10us(uint32_t time10us);
//void AD5940_ReadWriteNBytes(uint8_t *pSend, uint8_t *pRecv, uint32_t len);
//void AD5940_MCUResourceInit(void *pCfg);    // <-- note void* parameter
...
#define GPIO_SCLK  12//7   // D13 in Arduino UNO terms
#define GPIO_MISO 13//8   // D12 in Arduino UNO terms
#define GPIO_MOSI  11//9   // D11 in Arduino UNO terms
#define GPIO_CS  8//1    // D10 in Arduino UNO terms, this is a dummy pin that will not be used (AD5940 library was programmed in such a way that chip selects are handled manually)
#define AD5940_CS_PIN  10//4   // this is the true CS pin, AD5940 will not work with the default CS pin.
#define AD5940_GP0INT_PIN  4//3 // D2 in Arduino UNO terms, this connects to GPIO0 of AF5940
#define AD5940_RST_PIN  5//2    // A3/D17 in Arduino UNO terms
